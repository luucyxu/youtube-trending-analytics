...
# 项目根目录 = python_scripts 的上一级
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.dirname(CURRENT_DIR)

input_path = os.path.join(PROJECT_ROOT, "data_processed", "youtube_trending_combined.csv")
...
current_output_path = os.path.join(output_dir, f"youtube_trending_part{part_idx}.csv")
current_df_list = []

chunksize = 100_000

print("Start splitting...")
for chunk in pd.read_csv(input_path, encoding="latin1", chunksize=chunksize, engine="python", on_bad_lines="warn"):
